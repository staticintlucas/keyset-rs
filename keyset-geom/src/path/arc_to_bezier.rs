    ...
    fn test_arc_to_bezier() {
        ...
        let params = vec![
            ...
            Params {
                ...
                sf: false,
                d: Vector::new(2., 0.),
                exp: vec![Vector::new(1., 1.), Vector::new(1., -1.)],
            },
            Params {
                r: Vector::new(1., 1.),
                xar: Angle::zero(),
                ...
                sf: false,
                d: Vector::new(4., 0.),
                exp: vec![Vector::new(2., 2.), Vector::new(2., -2.)],
            },
            Params {
                r: Vector::zero(),
                xar: Angle::zero(),
