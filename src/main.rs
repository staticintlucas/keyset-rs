...
fn main() {
    let kle = r#"[
        ...
        [{"w": 1.75}, "Caps Lock", "A", "S", "D", {"n": true}, "F", "G", "H", {"n": true}, "J", "K", "L", ":\n;", "@\n'", "~\n#"],
        [{"w": 1.25}, "Shift", "|\n\\", "Z",  "X", "C", "V", "B", "N", "M", "<\n,", ">\n.", "?\n/", {"w": 2.75}, "Shift"],
        [{"w": 1.5}, "Ctrl", "Win", {"w": 1.5}, "Alt", {"p": "space", "a": 7, "w": 7}, "", {"p": "", "a": 4, "w": 1.5}, "AltGr", "Win", {"w": 1.5}, "Ctrl"]
    ]"#;
    let profile = r#"
        type = 'cylindrical'
        depth = 0.5
    ...
    let font = Font::from_ttf(&std::fs::read("open-cherry/OpenCherry-Regular.otf").unwrap());
    eprintln!("{font:?}");
